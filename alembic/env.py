...
from src.db.engine import get_engine, _make_absolute_sqlite_url, _normalize_db_url, _resolve_db_url  # noqa: E402
...
def _get_url() -> str:
    ...
    return _make_absolute_sqlite_url(_normalize_db_url(ini_url))
