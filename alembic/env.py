...
from src.db.engine import get_engine, _normalize_db_url, _resolve_db_url  # noqa: E402
...
def _get_url() -> str:
    ...
    if not ini_url or ini_url.startswith("driver://") or ini_url.startswith("sqlite"):
